...
import com.sebasorozcob.www.foodtil.util.NetworkListener
...
class RecipesFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    /**
     * The functions onQueryTextSubmit and onQueryTextChange are for the SearchView on the menu
     */
    ...
    /**
     * This function read the database and get information from local database if is not required
     * to get information from the API.
     * In case that the user change the meal type or diet type, the application gonna get new information
     * from the API, this new case is get with the "!args.backFromBottomSheet"
     */
